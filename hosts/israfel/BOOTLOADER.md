...
* [`rock-5b_UEFI_Release_v1.1.img`](https://github.com/edk2-porting/edk2-rk3588/releases/download/v1.1/rock-5b_UEFI_Release_v1.1.img) - UEFI bootloader image.
...
[nix-shell:~/rk3588]$ sudo rkdeveloptool wl 0 rock-5b_UEFI_Release_v1.1.img
